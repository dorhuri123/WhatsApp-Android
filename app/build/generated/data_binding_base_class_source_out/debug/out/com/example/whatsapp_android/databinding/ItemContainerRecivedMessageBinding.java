...
public final class ItemContainerRecivedMessageBinding implements ViewBinding {
  @NonNull
  ...
  private ItemContainerRecivedMessageBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ItemContainerRecivedMessageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemContainerRecivedMessageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_container_recived_message, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemContainerRecivedMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemContainerRecivedMessageBinding((ConstraintLayout) rootView, imageProfile,
